...
const Graph: FunctionComponent<SvgProps> = ({
  color,
  framed,
  size,
  frameColor,
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <rect x="10" y="5" width="4" height="14" rx="0.48" fill={fill} />
      <rect
        x="15"
        y="8"
        width="3"
