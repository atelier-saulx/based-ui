...
exports.genPathCurve = void 0;
const react_1 = __importDefault(require("react"));
const theme_1 = require("@based/theme");
const HoverPath_1 = __importDefault(require("./HoverPath"));
...
exports.genPathCurve = genPathCurve;
const genPath = (width, height, data, minY, ySpread, spread, segments, legend) => {
    ...
    if (stepSize < 10) {
        ...
        if (segments) {
            ...
            for (const key in pointArr) {
                const p = genPathCurve(prev ? [...pointArr[key]].reverse() : pointArr[key], stepSize / 2);
                const d = prev
                ...
                prev = pointArr[key];
                // add useHover
                children.push(react_1.default.createElement(HoverPath_1.default, { points: pointArr[key], d: d, i: i, amount: amount, code: key, key: key, legend: legend }));
            }
            const p = genPathCurve(points, stepSize / 2);
            paths = (react_1.default.createElement(react_1.default.Fragment, null,
                children,
                react_1.default.createElement("path", { d: p, fill: "none", stroke: theme_1.useColor({ color: 'primary', tone: 4 }), 
                    // @ts-ignore
                    data: "line", strokeWidth: 2 })));
        }
        else if (spread) {
            const p = genPathCurve(points, stepSize / 2);
            paths = (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("path", { d: genPathCurve(mins, stepSize / 2) +
                        `\nL${maxs[0][0]},${maxs[0][1]}` +
                        genPathCurve(maxs, stepSize / 2) +
                        `\nL${mins[0][0]},${mins[0][1]}`, fill: theme_1.useColor({ color: 'primary', tone: 2, opacity: 0.2 }) }),
                react_1.default.createElement("path", { d: p, fill: "none", stroke: theme_1.useColor({ color: 'primary', tone: 4 }), 
                    // @ts-ignore
                    data: "line", strokeWidth: 2 })));
        }
            ...
            const p = genPathCurve(points, stepSize / 2);
            paths = (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("path", { d: p +
                        `L${points[points.length - 1][0]},${points[points.length - 1][1]}L${points[points.length - 1][0]},${height},L0,${height}`, fill: theme_1.useColor({ color: 'primary', tone: 2, opacity: 0.2 }) }),
                react_1.default.createElement("path", { d: p, fill: "none", 
                    // @ts-ignore
                    data: "line", stroke: theme_1.useColor({ color: 'primary', tone: 4 }), strokeWidth: 2 })));
        }
    }
    else {
        if (segments) {
            ...
            const p = genPathCurve(points, stepSize / 2);
            paths = (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("path", { d: p + `L${width},${height},L0,${height}`, fill: theme_1.useColor({ color: 'primary', tone: 2, opacity: 0.2 }) }),
                react_1.default.createElement("path", { d: p, fill: "none", stroke: theme_1.useColor({ color: 'primary', tone: 4 }), 
                    // @ts-ignore
                    data: "line", strokeWidth: 2 })));
        }
...
exports.default = genPath;
//# sourceMappingURL=genPath.js.map