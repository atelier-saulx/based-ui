...
const get_service_1 = __importDefault(require("@based/get-service")); // will be replaced at some point
const uploadFile = async (files, progressContext, progressId, type = 'file', fake) => {
    // console.log({
    //   files,
    //   progressContext,
    //   progressId,
    ...
    if (files.length) {
        try {
            ...
            if (fake) {
                ...
                const fakeProgress = () => {
                    ...
                    if (item.progress >= 100) {
                        ...
                        progressContext.listeners.forEach((update) => update({ progressId, removed: true, progress: 100 }));
                    }
            ...
            if (progressContext.service) {
                ...
                url = (await get_service_1.default({
