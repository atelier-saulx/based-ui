...
const getFieldSizes = (width, itemProps, onOptions, large) => {
    let w = 0;
    if (onOptions) {
        width = width - 35;
    }
    const newItemProps = { ...itemProps, fields: [] };
    let imgCnt = 0;
...
exports.default = getFieldSizes;
//# sourceMappingURL=getFieldSizes.js.map